...
if("TRUE" STREQUAL "TRUE")
  set(ball_chaser_SOURCE_PREFIX /home/robond/Documents/monte-carlo-localization/src/ball_chaser)
  set(ball_chaser_DEVEL_PREFIX /home/robond/Documents/monte-carlo-localization/devel)
  ...
  set(ball_chaser_INSTALL_PREFIX /home/robond/Documents/monte-carlo-localization/install)
...
if(NOT "/home/robond/Documents/monte-carlo-localization/devel/include " STREQUAL " ")
  set(ball_chaser_INCLUDE_DIRS "")
  set(_include_dirs "/home/robond/Documents/monte-carlo-localization/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robond/Documents/monte-carlo-localization/src/ball_chaser/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robond/Documents/monte-carlo-localization/devel/lib;/opt/ros/kinetic/lib)
